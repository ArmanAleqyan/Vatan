...
class UserVerifyDocument extends Resource
{
    /**
    ...
    {
        return $query->where('status','Проверенно');
    }
    /**
    ...
    public static function label()
    {
        ...
        $getDoc = \App\Models\UserDocument::where('status','Проверенно')->count();
